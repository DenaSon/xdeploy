...
final class SupportedPlatformOperatingSystemsTest extends TestCase
{
     ...
     * @return iterable<string, array{string, string, string}>
     */
    public static function supportedCaddyOperatingSystems(): iterable
    {
        yield 'debian 12' => [
            'debian',
            '12',
    ...
    #[DataProvider('supportedCaddyOperatingSystems')]
    public function test_it_supports_the_caddy_installer_matrix(
        string $id,
        string $version,
        string $name,
    ): void {
     ...
     * @return iterable<string, array{string, string, string}>
     */
    public static function unsupportedCaddyOperatingSystems(): iterable
    {
        yield 'debian 11' => [
            'debian',
            '11',
    ...
    #[DataProvider('unsupportedCaddyOperatingSystems')]
    public function test_it_rejects_operating_system_versions_outside_the_caddy_matrix(
        string $id,
        string $version,
        string $name,
    ): void {
