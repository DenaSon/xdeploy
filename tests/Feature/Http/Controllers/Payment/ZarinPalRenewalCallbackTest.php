...
final class ZarinPalRenewalCallbackTest extends TestCase
{
    ...
    public function test_retryable_verification_failure_keeps_renewal_pending_and_offers_retry(): void
    {
        Carbon::setTestNow(
        ...
        $server = Server::query()->create([
            ...
            'status' => ServerStatus::Active,
            'cloud_provider' => 'arvan',
            'cloud_server_id' => 'retryable-renewal-server',
            'cloud_region' => 'eu-west1-a',
            'provisioned_at' => now()->subDay(),
            'expires_at' => Carbon::parse('2026-08-14 08:00:00'),
        ]);
        ...
        $payment = Payment::query()->create([
            ...
            'currency' => $order->currency,
            'status' => PaymentStatus::Pending,
            'gateway_reference' => 'AUTH-RETRYABLE-500',
            'gateway_transaction_id' => null,
            'redirect_url' => 'https://gateway.test/pay',
            'failure_code' => null,
            'verified_at' => null,
