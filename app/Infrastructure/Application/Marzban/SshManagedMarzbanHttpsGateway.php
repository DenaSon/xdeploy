...
final readonly class SshManagedMarzbanHttpsGateway implements MarzbanHttpsGateway
{
    ...
    public function __construct(
        ...
        private SshMarzbanHttpsGateway $legacyGateway,
    ...
    public function inspect(): MarzbanHttpsInfo
    {
        ...
        try {
            if (! $this->caddySites->exists($key)) {
                return $this->legacyGateway->inspect();
            }
    ...
    public function preflightDns(
        ...
        return $this->legacyGateway->preflightDns(
            domain: $domain,
    ...
    {
        $preflight = $this->legacyGateway->preflightServer();
