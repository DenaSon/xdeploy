...
final readonly class MarzbanHttpsDnsPreflightResult
{
    /**
    ...
    {
        return $this->resolvedIpv4Addresses
            === [$this->serverIpv4Address];
    }
    ...
    {
        return $this->ipv4MatchesServer()
            && ! $this->hasIncompatibleIpv6();
    }
