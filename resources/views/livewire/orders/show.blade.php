                ...
                <div class="min-w-0">
                    @if($serverReady)
                        ...
                        >
                            ...
                            اکنون می‌توانید مدیریت سرور را در Coreflare آغاز کنید.
                        </p>
                    @else
                        <h2
                            class="
        ...
        >
            <div>
                ...
                <p
                    ...
                    "
                >
                    مراحل آماده‌شدن VPS و اتصال به Coreflare
                </p>
            </div>
            ...
            @if($server)
                ...
                @else
                    <p
                        ...
                        "
                    >
                        VPS ساخته شده است؛ اتصال Coreflare پس از آماده‌شدن SSH فعال می‌شود.
                    </p>
                @endif
            @endif
